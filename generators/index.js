...
module.exports = class extends Generator {
    ...
    prompting() {
        ...
        this.log(yosay(`Welcome to the finest ${chalk.red("generator-express-mongodb-api")} generator!`));
    ...
    default() {
        if (this.authentication) {
            this.composeWith("express-mongodb-api:authentication", {
                name: this.name,
    ...
    writing() {
        this.fs.copyTpl(this.templatePath("_.env"), this.destinationPath(this.name + "/.env"));

        this.fs.copyTpl(this.templatePath("_nodemon.json"), this.destinationPath(this.name + "/nodemon.json"));

        this.fs.copyTpl(this.templatePath("_package.json"), this.destinationPath(this.name + "/package.json"));

        this.fs.copyTpl(this.templatePath("_tsconfig.json"), this.destinationPath(this.name + "/tsconfig.json"));

        this.fs.copyTpl(this.templatePath("_README.md"), this.destinationPath(this.name + "/README.md"));

        this.fs.copyTpl(this.templatePath("_tslint.json"), this.destinationPath(this.name + "/.eslintrc.json"));

        this.fs.copyTpl(this.templatePath("src/"), this.destinationPath(this.name + "/src/"), {
            name: this.name,
            authentication: this.authentication,
